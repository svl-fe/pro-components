"use strict";(self.webpackChunk_svl_ad_pro_components=self.webpackChunk_svl_ad_pro_components||[]).push([[268],{65697:function(g,o,e){e.r(o),e.d(o,{demos:function(){return L}});var v=e(15009),t=e.n(v),y=e(5574),E=e.n(y),R=e(99289),i=e.n(R),h=e(67294),L={"remote-select-demo-0":{component:h.memo(h.lazy(i()(t()().mark(function _(){var s,d,l,p,x,a;return t()().wrap(function(n){for(;;)switch(n.prev=n.next){case 0:return a=function(){return a=i()(t()().mark(function c(I){return t()().wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return console.log("fetching user",I),r.abrupt("return",fetch("https://randomuser.me/api/?results=10").then(function(m){return m.json()}).then(function(m){return m.results.map(function(u){return{label:"".concat(u.name.first," ").concat(u.name.last),value:u.login.username}})}));case 2:case"end":return r.stop()}},c)})),a.apply(this,arguments)},x=function(c){return a.apply(this,arguments)},n.next=4,Promise.resolve().then(e.t.bind(e,67294,19));case 4:return s=n.sent,d=s.default,n.next=8,Promise.resolve().then(e.bind(e,68632));case 8:return l=n.sent,p=l.RemoteSelect,n.abrupt("return",{default:function(){var c=d.useState([]),I=E()(c,2),b=I[0],r=I[1];return d.createElement(p,{showArrow:!0,mode:"multiple",value:b,loadMore:!0,addLinkUrl:"https://www.baidu.com/",placeholder:"Select users",fetchOptions:x,onChange:function(u){r(u)}})}});case 11:case"end":return n.stop()}},_)})))),asset:{type:"BLOCK",id:"remote-select-demo-0",refAtomIds:["remote-select"],dependencies:{"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
